...
const slice = createSlice({
  ...
  reducers: {
    ...
    changeToDoListFilterAC(state, action: PayloadAction<{  toDoListId: string,
      filter: FilterValuesType}>) {},
    changeToDoListTitleAC(state, action: PayloadAction<{toDoListId: string,
      title: string}>}) {},
    changeTodolistEntityStatusAC(state, action: PayloadAction<{  id: string,
      entityStatus: RequestStatusType}>) {},
  },
});
